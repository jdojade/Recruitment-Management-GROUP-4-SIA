            ...
            <div class="grid">
                <div class="activity-card">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                        <?php
                        include "includes/recruitmentlist.inc.php";
                        foreach($files as $file): ?>
                            <tr>
                                ...
                                <td>
                                <a href="includes/recruitmentlist.inc.php?file=<?php echo $file['applicantFile']?> "> View </a>
                                </td>
                                ...
                                <form action="includes/updatestatus.inc.php" method="post">
                                    ...
                                    <button type="submit" class="btn-info" name="updateToScreening">Move to Screening</button>
                                </form>
                                </td>
                                <td>
                                <form action="includes/updatestatus.inc.php" method="post">
