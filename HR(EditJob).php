...
include "includes/updatejobs.inc.php";
?>
<main>
         ...
         foreach($queryRun as $jobRow){
            ...
            <input type="hidden" name="jobId" value="<?php echo $jobRow['jobId']?>"class="form-control">
                ...
                <div class="Job-labels-2">
                    ...
                    <br>
                    <input type="hidden" name="jobImage" value="<?php echo $jobRow['jobImage']?>">
                    <input type="file" name="jobImage" class="job-upload-box" ><br> 	
                </div>         
                    
            </div>

            <button type="submit" name="updateJob" class="job-btn">Update</button>
        </form> 
        <?php
            }
                }
